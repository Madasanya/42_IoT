...
# Delete the dev namespace and all its resources
...
# Remove the cloned Gitlab repository
echo "Removing cloned Gitlab repository..."
sudo rm -rf /tmp/gitlab-repo-dbanfi_playground
